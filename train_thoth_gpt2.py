...
class CustomTextDataset(Dataset):
    def __init__(self, tokenizer, file_paths, block_size):
        ...
        for file_path in file_paths:
            ...
            tokens = tokenizer(text, return_tensors="pt", add_special_tokens=True)["input_ids"].squeeze()
...
# Replace with the path to your text corpus
train_files = ["train/corpus.txt", "train/presentations.txt", "train/transcripts.txt"]
# check gpu
